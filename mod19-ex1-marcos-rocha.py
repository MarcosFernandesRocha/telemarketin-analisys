...
def main():
    ...
    st.set_page_config(page_title = 'Telemarketing analysis - Marcos Rocha', \
        page_icon = '../img/Bank-Branding.png',
        layout="wide",
        initial_sidebar_state='expanded'
    )

    # Título principal da aplicação
    st.write('# Telemarketing analysis - Marcos Rocha')
    st.markdown("---")
    
    # Apresenta a imagem na barra lateral da aplicação
    image = Image.open("../img/BANK.jpg")
